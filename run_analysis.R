...
# This script uses UCI HAR Dataset downloaded from 
...
library(data.table)
library(reshape2)
#set working directory to unzipped UCI HAR Data Folder
setwd('/Users/113329/DataCleaning/getdata-UCI');
...
# Load activity data
y_train[,2] = actv_labels[y_train[,1]]
